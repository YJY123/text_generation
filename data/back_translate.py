...
# -*- coding: UTF-8 -*-
"""
@Description: 文本增强 ---> 回译方法
@File: /text_generation/data/back_translate.py
"""
...
def translate(q, source, target):
    ...
    appid = '20210311000723130'  # Fill in your AppID
    secretKey = '8J5Uvsr4PAEjMMWoKvQ1'  # Fill in your key
